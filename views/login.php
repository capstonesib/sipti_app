          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="login.ejs" class="app-brand-link gap-2">
                  
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Welcome to Sipti App</h4>
              <br>
              ...
              <p class="text-center">
                <span>Anda seorang pengelola wisata?</span>
