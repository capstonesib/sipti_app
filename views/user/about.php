...
<body>
            ...
            <nav class="navbar navbar-light navbar-expand-lg py-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="tempat_wisata.php" class="nav-item nav-link">Destinasi liburan</a>
                        <a href="about.php" class="nav-item nav-link active">About</a>
                    </div>
                    <a href="../login.php" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">Login/register</a>
                </div>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light py-6 my-6 mt-0">
        <div class="container">
        <div class="pembuat" style="display: flex; justify-content: space-around;">
                <div class="card-pembuat">
                    <img src="" alt="sdsds">
                    <h3>Abdi</h3>
                    <p>30 orang</p>
                </div>
